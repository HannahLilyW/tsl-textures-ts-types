...
The idea of having a separate (from DefinitelyTyped) development and staging area for the tsl-textures type declarations was inspired by https://github.com/three-types/three-ts-types which does the same thing for the three.js type declarations. That repo was used as a guide for this one.
